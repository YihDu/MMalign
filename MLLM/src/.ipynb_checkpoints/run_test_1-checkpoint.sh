...
MODEL_PATH="/root/personal/hf_models/QwenVL25/Qwen2.5-VL-32B-Instruct"
SAVE_DIR="/root/personal/expriments/results_vqa_multilingual/Qwen-VL-v25/32B/hidden_state"
LANGS="EN,KO,SR,HU,AR,CS,TH,ZH,RU,VI"
MAX_SAMPLES=10
layer_interval=2
batch_size=1

python test_vqa_1_32B.py \
  --data_path "$DATA_PATH" \
